...
We welcome contributions to the laravelmaroc.com project. Please read the following guide before posting an issue or sending
...
- **Feature requests** first need to be discussed and accepted [through an issue](https://github.com/laravelmorocco/laravelmaroc.com/issues/new) before sending in a pull request
...
- The rest of the coding standards will automatically fixed by [Github Actions](https://github.com/laravelmorocco/laravelmaroc.com/actions)
