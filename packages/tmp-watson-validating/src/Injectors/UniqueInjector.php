...
trait UniqueInjector
{
    ...
    protected function prepareUniqueRule($parameters, $field)
    {
        ...
        if (( ! str_contains($parameters[0], '.')) && (($connectionName = $this->getModel()->getConnectionName()) !== null)) {
        ...
        if ($this->exists) {
            ...
            if ( ! isset($parameters[2]) || 'null' === mb_strtolower($parameters[2])) {
