<div class="bg-skin-menu">
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-4">
        <nav class="border-t border-skin-base py-3 flex items-center space-x-3" aria-label="Global">
            ...
            <a href="{{ route('cpanel.analytics') }}" class="inline-flex text-sm font-medium rounded-md py-2 px-3 items-center {{ active(['cpanel.analytics*'], 'bg-green-50 text-green-800', 'text-skin-base hover:bg-skin-card-muted hover:text-skin-inverted') }}">
                {{ __('Analytics') }}
            </a>
            ...
            <a href="#" class="inline-flex text-sm font-medium rounded-md py-2 px-3 items-center {{ active(['cpanel.submissions*'], 'bg-green-50 text-green-800', 'text-skin-base hover:bg-skin-card-muted hover:text-skin-inverted') }}">
