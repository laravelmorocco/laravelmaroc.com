...
@php
    $classes =
        ...
        ($success ? 'bg-green-500 border border-transparent text-white hover:bg-green-600 focus:ring-green-500 active:bg-green-900 focus:outline-none focus:border-red-900' : '') .
        ...
        ($successOutline ? 'bg-transparent border border-red-500 text-green-500 hover:bg-green-500 hover:text-white active:bg-green-900 focus:outline-none focus:border-red-900 focus:ring ring-green-300' : '') .
