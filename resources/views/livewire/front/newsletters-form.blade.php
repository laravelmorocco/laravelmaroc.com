<div>
    <div class="px-4">
        ...
        <form wire:submit.prevent="newsletterform" class="flex items-center justify-center">
            ...
            <button
                class="w-32 rounded-l-none bg-red-600 hover:bg-red-700 rounded font-medium leading-none text-white p-3 uppercase focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700 shadow-md">
